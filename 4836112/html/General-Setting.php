                                            ...
                                            <form novalidate>
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       id="account-username" placeholder="Company Name"
                                                                       value="" required
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="account-name">Website Url</label>
                                                                <input type="text" class="form-control"
                                                                       id="account-name" placeholder="URL" value=""
                                                                       required
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="account-e-mail">Application Time
                                                                    Zone</label>
                                                                <input type="email" class="form-control"
                                                                       id="account-e-mail" placeholder="Time zone"
                                                                       value="" required
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <div class="controls">
                                                                ...
                                                                <select name="Currency Mode" class="form-control">
                                                                    <option selected> Currency Mode</option>
                                                                    <option>INR</option>
                                                                    <option>USD</option>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-6 col-md-12">
                                                                                    <fieldset class="form-group">
                                                                                        <label for="basicInputFile">Currency
                                                                                            Symbol</label>
                                                                                        <input type="text"
                                                                                               class="form-control"
                                                                                               id="accountname"
                                                                                ...
                                                                                <div class="col-lg-6 col-md-12">
                                                                                    <fieldset class="form-group">
                                                                                        <label for="basicInputFile">Company
                                                                                            Logo</label>

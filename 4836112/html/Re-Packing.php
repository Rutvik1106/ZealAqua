...
if (isset($_SESSION['loggedinclient']) && $_SESSION['loggedinclient'] === true) {
    ...
    if ($module === "Repacking" or $module === "Admin") {
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Re-Packing</h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group">
                                                    <fieldset>New Weight</fieldset>
                                                    <input type="text" id="newWt" class="form-control"
                                                           placeholder="New Weight" name="newWt">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group">
...
if (isset($_POST['submit'])) {
    ...
    $Rate = $_POST['Rate'];
    $Amount = $_POST['Amount'];
    $sql = "UPDATE `repack` SET `lotdate`='$LotDate' ,`grade`='$grade' ,`varitey`='$variety' ,`brandco`='$brandCo' ,`glaze`='$Glaze' ,
`freezer`='$freezer',`pack1`='$Pack1',`pack2`='$Pack2',`slab`='$Slab',`netkg`='$NetKg',`frozenkg`='$FrozenKg' ,`newWt`='$newWt',`mccartoon`='$McCartoon',
...
<script>
    ...
    $(document).ready(function () {
        $('#detailsIn').on('click', function () {
            ...
            var loatno = $('#view_lot').val();
            $.ajax({
                type: 'POST',
                url: 'getRePackData.php',
                dataType: "json",
                data: {loat_no: loatno},
                success: function (data) {
                    if (data.status == 'ok') {
